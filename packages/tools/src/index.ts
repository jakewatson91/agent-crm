...
export { generateResearchStrategy, planResearchAngles, ensureResearchStrategy, persistResearchStrategy, stampRecordSince, carryOffSwitch, failedAngles, orphanedAngles, loadAngleRecords, clampQuery, angleRecordBlock, resolveStrategy, resolveContactStrategy, filterResultsByEntity, fetchEntityGrounding, pageMentionsEntity, readEntityAliases, dedupeResearchCandidates, DUP_LOOKBACK_DAYS, BASELINE_ANGLES, type PlannerContext, type AngleRecord, type RelevanceResult, type RelevanceTarget, type GateRejectReason } from './research_strategy.ts';
export { generateResearchBrief, planResearchBrief, ensureResearchBrief, persistResearchBrief, briefInputHashFor, loadQuestionRecords, resolveBrief, renderBrief, BASELINE_BRIEF, PAIN_QUESTION, type BriefContext, type QuestionRecord } from './research_brief.ts';
