 ...
 */
export const SCORE_DIMENSIONS: Record<string, { label: string; help: string }> = {
  industry_match: { label: 'Industry match', help: 'How closely their market matches who you sell to.' },
  stage_match: { label: 'Stage & size', help: 'Whether their funding stage and team size fit your target.' },
  ...
  recency: { label: 'Freshness', help: 'How recent the information we have on them is.' },
  graph_proximity: { label: 'Network proximity', help: 'How well their connections in your data fit.' },
};
